...
const Skill = ({ skillData, loadUserData, isDarkMode }) => {
  ...
  const submitEditProgression = async () => {
    ...
    if (
      editCurrent === skillData.current[editIndex] &&
      editGoal === skillData.goal[editIndex] &&
          ...
          <View style={[tw`p-4`, {}]}>
            ...
            {skillData.progressions.map((progression, index) => (
              <View key={index} style={tw`flex-row items-center mt-4`}>
                ...
                <ProgressCircle
                  current={skillData.current[index]}
                  goal={skillData.goal[index]}
                />
              </View>
            ))}
          </View>
                ...
                {skillData.progressions.slice(1).map((progression, index) => (
                  ...
                  >
                    <View style={tw`flex-1`}>
                      ...
                      >
                        {skillData.current[index + 1]}/
                        {skillData.goal[index + 1]}
                      </Text>
                    </View>
                    <ProgressCircle
                      current={skillData.current[index + 1]}
                      goal={skillData.goal[index + 1]}
                    />
                  </View>
                ))}
              </View>
